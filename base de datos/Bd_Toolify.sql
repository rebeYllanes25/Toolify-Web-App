...
INSERT INTO TB_USUARIO (NOMBRES, APE_PATERNO, APE_MATERNO, CORREO, CLAVE, NRO_DOC, DIRECCION, ID_DISTRITO, TELEFONO, ROL,imagen_usuario)
VALUES
...
('Pedro','Mendoza','Cruz','pedro.mendoza@example.com','clave123','33445566','Av. Bolívar 987',2,'987654327',2,null), -- cliente 6

('Juan','Gonzales','Meza','juan.gonzales@example.com','clave123','34567890','Jr. Perú 789',3,'987654323',3,null), --Vendedor 1

('Ana','Torres','Díaz','ana.torres@example.com','clave123','45678901','Psje. Andino 012',4,'987654324',4,null), -- Repartidor 1
('Andy','Valdivia','Centeno','andy.centeno@gmail.com','andy123','76987423','Av. Riva Agüero 234',2,'937150514',4,'https://res.cloudinary.com/dheqy208f/image/upload/v1761684378/TooLifyWeb/Products/rpconaysu51uhj6apkp1.png'),--Repartidor 2
('Jose','Julca','Chumpitaz','jose.julca@gmail.com','jose123','75454531','Av. Inka Garcilaso de la Vega 123',2,'986425458',4,'https://res.cloudinary.com/dheqy208f/image/upload/v1761684472/TooLifyWeb/Products/caelk6e0vkghfhgjrch9.png'),--Repartidor 3
('Jorge','Rojas','Vega','jorge.rojas@example.com','clave123','44556677','Calle Central 654',1,'987654328',4,null), --Repartidor 4
('Lucía','Campos','Reyes','lucia.campos@example.com','clave123','55667788','Jr. Los Álamos 159',3,'987654329',4,null), --Repartidor 5
('Rosa','Gutiérrez','Salas','rosa.gutierrez@example.com','clave123','66778899','Av. Primavera 753',2,'987654330',4,null); --Repartidor 6
