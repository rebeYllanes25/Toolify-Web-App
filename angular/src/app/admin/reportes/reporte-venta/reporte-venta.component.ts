...
export class ReporteVentaComponent implements OnInit {
  ...
  estadoMap: { [key: string]: { label: string; cssClass: string } } = {
    G: { label: 'Generado', cssClass: 'status-generated' },
    P: { label: 'Pendiente', cssClass: 'status-pending' },
    E: { label: 'Entregado', cssClass: 'status-completed' },
    C: { label: 'Cancelado', cssClass: 'status-cancelled' },
  };
